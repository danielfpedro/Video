<div class="actions columns large-2 medium-3">
    <h3><?= __('Actions') ?></h3>
    <ul class="side-nav">
        <li><?= $this->Html->link(__('Edit Artists Video'), ['action' => 'edit', $artistsVideo->video_id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Artists Video'), ['action' => 'delete', $artistsVideo->video_id], ['confirm' => __('Are you sure you want to delete # {0}?', $artistsVideo->video_id)]) ?> </li>
